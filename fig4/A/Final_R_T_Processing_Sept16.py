...
LF = np.round(np.log10(Trans_Amp/Rad_Amp), decimals=2)


######### Figure of 3 component Time-Series #################################
...
plt.plot(TR_R.times()/(60*60),(TR_R.data*1000000.)+0.1,linewidth=1,c='g',linestyle='dashed', label='Radial', alpha=0.5)
plt.plot(TR_T.times()/(60*60),(TR_T.data*1000000.)-0.1,linewidth=2,color='xkcd:hot pink', label='Transverse:' + str(LF), alpha=0.3)
...
########################################################################
plt.savefig(fname='./VRT_Figs/' + sta + '_3_VRT.png')

# plt.show()

print('Rob Here is your stuff:', sta, ',', s_lat, ',', s_lon, ',', BAZ, ',', value_Ray, ',', Vert_Amp, ',', Rad_Amp, ',', Trans_Amp, ',' , LF)
